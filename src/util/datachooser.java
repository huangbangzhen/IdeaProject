...
public class datachooser extends JPanel{
    ...
    public datachooser(String format){
        this(new Date(), format);
    }
    public datachooser(Date date, String format){
        initDate=date;
...
//      this.add(toSelect,BorderLayout.EAST);
    ...
    public void commit(){
        ...
        hidePanel();
        string=sdf.format(select.getTime());
    }
    //隐藏日期选择面板
...
//        final datachooser mp = new datachooser("yyyy-MM-dd");
